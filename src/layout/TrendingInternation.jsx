...
export default function TrendingInternation() {
  ...
  useEffect(() => {
    fetch("Services/TrendingInternationalTour.json")
    ...
    <>
      <section>
        <div className=" sm:p-12 p-6 text-gray-200">
          <div>
            <div className="py-6">
              <h2 className="text-center text-3xl italic uppercase font-bold text-gray-200 underline decoration-yellow-500 underline-offset-8">
                Trending International Tour Destinations
              </h2>
              <br />
              <div className="block justify-center px-4 text-gray-200 text-[15px] font-serif">
                <p className="text-center">
                  Its time to organize an international tour if you want to
                  escape the monotony of life. With Risezonic Travel, you dont
                  have to worry about anything. If this is your first time
                  traveling abroad and you Are not sure where to go, these are
                  some suggested destinations. You can select an international
                  tour package that includes these locations for well-known
                  attractions and plenty of flight options.
                </p>
              </div>
            </div>
