...
const destinations = [
    {
        image: "https://i.postimg.cc/kgwYbh75/Bali_international.jpg",
        location: "Bali",
    ...
    {
        image: "https://i.postimg.cc/3wRSCCwh/Italian_Amalfi_image.jpg",
        location: "Italy",
    ...
    {
        image: "https://i.postimg.cc/nLzRYYLJ/maldives_international.jpg",
        location: "Maldives",
    ...
    {
        image: "https://i.postimg.cc/0yZXwHP4/Santorini_international.jpg",
    ...
    {
        image: "https://i.postimg.cc/28RtRZ0H/Thailand_international.jpg",
        location: "Thailand",
...
export default function Internationalhonemoonbanner() {
                    ...
                    >
                        <button className="group relative px-8 py-4 bg-yellow-500 text-white font-semibold rounded-full overflow-hidden hover:bg-yellow-600 transition-all hover:scale-105">
                            <span className="relative z-10 flex items-center gap-2">
                                ...
                                <Link to="tel:+ ++91 8588809690" >Book Your Trip </Link>
