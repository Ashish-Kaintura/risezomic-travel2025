...
const HoneymoonIndiaDetails = () => {
  ...
  const canonicalUrl = `https://www.risezonictravel.com/honeymoon-packages/${UrlTitle}`;
  return (
    <div>
      <Helmet>
        <title>book cheap flight tickets</title>
...
export default HoneymoonIndiaDetails;
