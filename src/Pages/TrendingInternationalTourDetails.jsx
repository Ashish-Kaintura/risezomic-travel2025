...
const TrendingInternationalTourDetails = () => {
  ...
  const canonicalUrl = `https://www.risezonictravel.com/international-holiday-packages/${UrlTitle}`;
             ...
             <div className="grid sm:grid-cols-2 gap-10 items-start">
               ...
               <div>
                 ...
                 <div className="flex gap-4 mt-5">
                   ...
                   <a
                     href={`https://wa.me/+918588809690?text=Hi, I'm interested in ${service.title} package`}
                     target="_blank"
...
export default TrendingInternationalTourDetails;
