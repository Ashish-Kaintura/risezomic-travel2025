        ...
        <div className="flex justify-start gap-x-5 sm: mt-12">
          ...
          <div>
            ...
            <p className="flex sm:w-[850px]  p-5 px-0 text-gray-600">
              At Risezonic Travel, we understand that your safety and peace of
              mind are of the utmost importance, which is why we offer
              comprehensive travel insurance solutions to protect you every step
              of the way. No matter if you are going on a family vacation or if
              you’re planning a business trip our insurance specialists will go
              through your necessities step by step and offer a policy that will
              give you the most appropriate insurance coverage for your trip.
              Rely on Risezonic Travel to protect your travels and enhance your
              most critical meetings and events. Give us a call today to learn
              how we can support you and be your companion in this journey that
              you deserve.
            </p>
